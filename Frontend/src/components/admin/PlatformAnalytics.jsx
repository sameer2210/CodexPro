...
import { Users, FileText, Award, Clipboard } from 'lucide-react';
    ...
    useEffect(() => {
        const fetchStats = async () => {
            try {
                ...
                setError('Failed to load platform stats', err);
            } finally {
                setLoading(false);
            }
        };
        ...
        >
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <StatCard icon={<FileText />} title="Total Submissions" value={stats.totalSubmissions} color="green" />
                    <StatCard icon={<Award />} title="Total Contests" value={stats.totalContests} color="purple" />
                    <StatCard icon={<Clipboard />} title="Total Problems" value={stats.totalProblems} color="red" />
                </div>
            </div>
        </motion.div>
    );
