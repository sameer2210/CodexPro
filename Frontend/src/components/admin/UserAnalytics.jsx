...
const UserAnalytics = () => {
    ...
    if (loading) {
        return <div className="text-center p-8 text-orange-500">Loading...</div>;
    }
    ...
    return (
        <motion.div
            ...
            className="p-8 bg-gray-900 min-h-screen text-gray-200"
        >
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
                    <div className="bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-700 flex items-center">
                        <Users className="text-5xl text-orange-500 mr-6" />
                        <div>
