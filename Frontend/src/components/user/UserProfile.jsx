...
const UserProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axiosClient.put("/user/updateProfile", {
  ...
  const handleRequestVerificationOTP = async () => {
    ...
    try {
      await axiosClient.post("/user/requestEmailVerificationOTP", { email: emailForVerification });
  ...
  const handleVerifyEmail = async () => {
    if (!verificationOtp) {
      setValidationErrors((prev) => ({ ...prev, otp: "OTP is required" }));
      return;
    }
    try {
      await axiosClient.post("/user/verifyEmailOTP", { email: emailForVerification, otp: verificationOtp });
